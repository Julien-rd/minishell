...
/*   Updated: 2025/09/29 14:03:26 by jromann          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

// #include "minishell.h"

// static int	ex_encounter(t_input *data, t_expand_helper *exh,
...
// 		ft_memcpy(&data->exp_str[exh->str_iter], str->env_arr[exh->env_iter],
// 			exh->len);
// 		exh->env_iter++;
